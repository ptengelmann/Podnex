...
const ApplicationsCreator = () => {
      ...
      try {
        ...
        try {
          ...
          if (currentUser.role !== 'creator') {
            console.warn('Non-creator attempting to access creator page');
            setError('You do not have creator access');
            setLoading(false);
            return;
          }
  ...
  const filteredApplications = applications.filter(app => {
    ...
    const searchMatch = 
      ...
      (app.applicant?.name && app.applicant.name.toLowerCase().includes(searchTerm.toLowerCase()));
